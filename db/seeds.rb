...
@merchant1 = Merchant.create!(name: "Raul Rodriguez")
@merchant2 = Merchant.create!(name: "Silvia Juanes")
...
@discount_3 = BulkDiscount.create!(percentage_discount: 0.10, quantity_threshold: 25, merchant_id: @merchant1.id)
@discount_4 = BulkDiscount.create!(percentage_discount: 0.50, quantity_threshold: 50, merchant_id: @merchant1.id)
